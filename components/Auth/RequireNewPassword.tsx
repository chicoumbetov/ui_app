  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }} behavior={Platform.OS == 'ios' ? 'padding' : 'height'}>
      <Layout style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        ...
        <Text category="h1" style={AuthStyles.header}>Changer le mot de passe</Text>
        ...
        <Button appearance="ghost" style={AuthStyles.button} onPress={goBack}>Retour à Sign In</Button>
      </Layout>
