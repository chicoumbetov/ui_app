...
import {
  TabIndicatorElement,
} from '@ui-kitten/components/ui/shared/tabIndicator.component';
...
export class BottomNavigation extends React.Component<BottomNavigationProps> {
  ...
  private renderTabElement = (element: BottomNavigationTabElement, index: number): BottomNavigationTabElement => React.cloneElement(element, {
    key: index,
  ...
  private renderTabElements = (source: ChildrenWithProps<BottomNavigationTabProps>): BottomNavigationTabElement[] => React.Children.map(source, this.renderTabElement);
