...
export class TabIndicator extends React.Component<TabIndicatorProps> {
  ...
  private createOffsetAnimation = (params: { offset: number, animated?: boolean }): Animated.CompositeAnimation => Animated.timing(this.contentOffset, {
  ...
  public render(): React.ReactElement<ViewProps> {
    ...
    return (
      <Animated.View
        {...viewProps}
        style={[style, evaStyle, { backgroundColor: 'transparent' }]}
